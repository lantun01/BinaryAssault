...
float4 Mask2RGBA_1 = lerp(NewTex_1,float4(1,1,0,1), lerp(NewTex_2.r, 1 - NewTex_2.r ,_Mask2RGBA_Fade_1));
float4 ClippingRight_1 = ClippingRight(Mask2RGBA_1,i.texcoord,_ClippingRight_Value_1);
