...
Shader "Shadero Customs/Transition"
{
Properties
{
[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
AnimatedOffsetUV_X_1("AnimatedOffsetUV_X_1", Range(-1, 1)) = 0.1
AnimatedOffsetUV_Y_1("AnimatedOffsetUV_Y_1", Range(-1, 1)) = -0.125
...
_TintRGBA_Color_1("_TintRGBA_Color_1", COLOR) = (0.1222048,1,0,1)
...
float4 TintRGBA_2 = TintRGBA(NewTex_2, float4(0,0,0,1));
float4 OperationBlend_1 = OperationBlend(TintRGBA_2, NewTex_1, _OperationBlend_Fade_1); 
float4 TintRGBA_1 = TintRGBA(OperationBlend_1,_TintRGBA_Color_1);
float4 ClippingRight_1 = ClippingRight(TintRGBA_1,i.texcoord,_ClippingRight_Value_1);
