...
Shader "Shadero Customs/PlayerDash"
{
Properties
{
...
_Hologram_Speed_1("_Hologram_Speed_1", Range(0, 4)) = 4
...
float4 _Hologram_1 = Hologram(AnimatedOffsetUV_1,_SourceNewTex_1,_Hologram_Value_1,_Hologram_Speed_1);
